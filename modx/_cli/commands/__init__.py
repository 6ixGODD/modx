...
def parse_args() -> argparse.Namespace:
    from modx._cli.commands import run

    parser = argparse.ArgumentParser(description='ModX Server Command Line Interface',
                                     prog='python -m modx',
    ...
    if not env_file.exists():
        warnings.warn(
            ...
            f"environment variables from this file.", UserWarning)
