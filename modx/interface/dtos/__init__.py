...
class BaseModel(pydt.BaseModel):
    model_config: t.ClassVar[pydt.ConfigDict] = (
        pydt.ConfigDict(
            extra='allow',
...
_ResponseT = t.TypeVar(
    "_ResponseT",
    bound=t.Union[BaseModel, t.Mapping[str, t.Any], t.List]
)
...
class Response(BaseModel, t.Generic[_ResponseT]):
    ...
    code: t.Annotated[
        ...
        pydt.Field(
            ...
            examples=[const.BusinessCode.SUCCESS]
        )
    ] = const.BusinessCode.SUCCESS
    ...
    data: t.Annotated[
        ...
        pydt.Field(
            ...
            description="The actual response data. Structure varies based on "
                        "the endpoint.",
            examples=[{"key": "value"}, {"items": [1, 2, 3]}]
        )
    ] = None
...
class ErrorResponse(Response[exc.ExceptionDetails]):
    ...
    code: t.Annotated[
        ...
        pydt.Field(
            ...
            examples=[const.BusinessCode.UNKNOWN_ERROR,
