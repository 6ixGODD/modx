...
from modx.interface.dtos.compat import ChatCompletionChoice
from modx.interface.dtos.compat import ChatCompletionChunk
from modx.interface.dtos.compat import ChatCompletionChunkChoice
from modx.interface.dtos.compat import ChatCompletionChunkDelta
from modx.interface.dtos.compat import ChatCompletionMessage
from modx.interface.dtos.compat import ChatCompletionParams
from modx.interface.dtos.compat import CompatResponse
...
class ICompatInterface(t.Protocol):
    ...
    async def chat_completions(self, params: ChatCompletionParams) -> CompatResponse:
        ...
...
class CompatInterface(BaseInterface):
    ...
    def __init__(self, *, logger: Logger, compat_service: ICompatService):
    ...
    async def chat_completions(self, params: ChatCompletionParams) -> CompatResponse:
        ...
        chatcmpl_id = (ChatCompletionID(
            id=params.chat_id) if params.chat_id and params.cache else None)
