...
from modx.chatbot.types.completion import Completion, CompletionMessage
from modx.chatbot.types.completion_chunk import (
    CompletionChunk,
...
class ChatCompletion(Chatbot, LoggingTagMixin):
    ...
    async def chat(
        ...
        **kwargs: t.Any
        ...
        message_list = ([
                            openai_chat.ChatCompletionSystemMessageParam(
                                role='system',
                                content=sysprompt
                            )
                        ] +
        ...
        if stream:
            ...
            if cache:
                ...
                async def cache_on_complete() -> t.AsyncIterable[
                    CompletionChunk]:
